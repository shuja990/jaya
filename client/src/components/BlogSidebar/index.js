        ...
        <div className="col col-lg-4 col-12">
            <div className="wpo-blog-sidebar">
                ...
                <div className="widget category-widget">
                    <h3>Categories</h3>
                    <ul>
                        <li><Link to="/blog-details">Helping Poor</Link></li>
                        <li><Link to="/blog-details">Water Problem</Link></li>
                        <li><Link to="/blog-details">Charity</Link></li>
                        <li><Link to="/blog-details">Medical Campain</Link></li>
                        <li><Link to="/blog-details">Free Food</Link></li>
                    </ul>
                </div>
