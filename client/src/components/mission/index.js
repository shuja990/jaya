                ...
                <div className="row">
                    <div className="col-12">
                        <div className="" style={{textAlign:"center"}}>
                            <h2>We believe the empowerment of the diaspora is crucial to Jamaica's national development  and it is our job to do so</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12 col-12 custom-grid">
                            <div className="wpo-mission-item">
                                ...
                                <div className="wpo-mission-content">
                                    <h2>Our Mission</h2>
                                    <p>Uplifting each other and Jamaicans on the mainland by providing mentorship, networking opportunities and advocacy around issues affecting the diaspora.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6 col-sm-12 col-12 custom-grid">
                            <div className="wpo-mission-item">
                                ...
                                <div className="wpo-mission-content">
                                    <h2>Our Vision</h2>
                                    <p>To help Jamaica achieve Vision 2030 through the development of the diaspora</p>
                                </div>
                            </div>
                        </div>
