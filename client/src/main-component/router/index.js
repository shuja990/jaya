    ...
    <div className="App">
       <Router>
          <Switch>
            ...
            <Route path='/president-welcome' component={President} />
            <Route path='/about' component={AboutPage} />
            <Route path='/projects' component={CasePage} />
            <Route path='/case-single' component={CaseSinglePage}/>
            <Route path='/covid-19' component={CaseSinglePage}/>
            <Route path='/old-age-home' component={CaseSinglePage}/>
            <Route path='/upcoming-events' component={EventPage}/>
